(function (global) {
  'use strict';
const PRESALES_STAGES = Object.freeze([
  'Intake', 'Sizing', 'Product/BOQ', 'Risk', 'Quote/PDF', 'Handoff'
]);

const PRESALES_ASSUMPTION_STATUS = Object.freeze({
...
const PRESALES_RISK_STATUS = Object.freeze({
  open: 'Open risks',
  needs_review: 'Needs engineering review',
  accepted: 'Accepted for proposal'
});

const PRESALES_READINESS_LABEL = 'BD Readiness';

const PRESALES_COPY = Object.freeze({
  en: Object.freeze({
...
const PRESALES_INTAKE_DEFAULTS = Object.freeze({
  siteName: '',
  location: '',
  facilityType: '',
...
const PRESALES_EVIDENCE_DEFAULTS = Object.freeze({
...
function normalizePresalesProject(record = {}) {
...
function buildPresalesEvidenceGaps(project = {}, quote = null, epc = null) {
...
function calculatePresalesReadiness(project = {}, quote = null, epc = null) {
  const normalized = normalizePresalesProject(project);
  const intake = normalized.intakeBasis;
  const evidence = normalized.evidenceStatus;
  const intakeChecks = [
...
function buildPresalesOpportunityModel(project = {}, quote = null, epc = null) {
  const normalized = normalizePresalesProject(project);
  return {
    project: normalized,
    quote,
  ...
  global.MinovaPresalesWorkbench = Object.freeze({
    PRESALES_STAGES,

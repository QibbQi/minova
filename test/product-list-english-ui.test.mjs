...
test('engineering workspace exposes certification matrix filters and seeded catalog state', () => {
  ...
  [
    ...
    "querySelectorAll('#engineering-detail-template-bulk-list input[data-engineering-detail-product], #engineering-detail-template-bulk-list select[data-engineering-detail-product]')",
